...
/// sample.
///
/// The round draws through `connect_random_peer_excluding` (chia-query 0.10.0), telling the helper
...
/// chia-query 0.10.0 the round can EXCLUDE what it holds, so the ordinary co-resident-node case no
